...
class _ActuationModel:
    ...
    def __attrs_post_init__(self):
        if self.model_pth == 'proportional_1.0_5k_3.pt':
            print('##########5K!##########')
            self.x_scaler = load(open('/private/home/jtruong/repos/habitat-sim/habitat_sim/agent/controls/scalers/x_scaler_prop_5k.pkl', 'rb'))
            self.y_scaler = load(open('/private/home/jtruong/repos/habitat-sim/habitat_sim/agent/controls/scalers/y_scaler_prop_5k.pkl', 'rb'))
        elif self.model_pth == 'proportional_1.0_1k_3.pt':
            print('##########1K!##########')
            self.x_scaler = load(open('/private/home/jtruong/repos/habitat-sim/habitat_sim/agent/controls/scalers/x_scaler_prop_1k.pkl', 'rb'))
            self.y_scaler = load(open('/private/home/jtruong/repos/habitat-sim/habitat_sim/agent/controls/scalers/y_scaler_prop_1k.pkl', 'rb'))
        elif self.model_pth == 'proportional_1.0_500_3.pt':
            print('##########500!##########')
            self.x_scaler = load(open('/private/home/jtruong/repos/habitat-sim/habitat_sim/agent/controls/scalers/x_scaler_prop_500.pkl', 'rb'))
            self.y_scaler = load(open('/private/home/jtruong/repos/habitat-sim/habitat_sim/agent/controls/scalers/y_scaler_prop_500.pkl', 'rb'))
        elif self.model_pth == 'proportional_1.0_250_3.pt':
            print('##########250!##########')
            self.x_scaler = load(open('/private/home/jtruong/repos/habitat-sim/habitat_sim/agent/controls/scalers/x_scaler_prop_250.pkl', 'rb'))
            self.y_scaler = load(open('/private/home/jtruong/repos/habitat-sim/habitat_sim/agent/controls/scalers/y_scaler_prop_250.pkl', 'rb'))
        elif self.model_pth == 'proportional_1.0_100_3.pt':
            print('##########100!##########')
            self.x_scaler = load(open('/private/home/jtruong/repos/habitat-sim/habitat_sim/agent/controls/scalers/x_scaler_prop_100.pkl', 'rb'))
            self.y_scaler = load(open('/private/home/jtruong/repos/habitat-sim/habitat_sim/agent/controls/scalers/y_scaler_prop_100.pkl', 'rb'))
        ...
        checkpoint = torch.load('/private/home/jtruong/repos/habitat-sim/habitat_sim/agent/controls/regression_models/' + self.model_pth, map_location='cpu')
